...
public final class ChangeCalculatorService implements IDatabaseChangeCaculator {
  ...
  public void executeCalculate(@NonNull TaskParamEntity task,
    ...
    IMetaDataByDatasourceService
        oldMd = new MetaDataByDataSourceServiceImpl(task.getOldDataSource(), task.getOldProductType());
    IMetaDataByDatasourceService
        newMd = new MetaDataByDataSourceServiceImpl(task.getNewDataSource(), task.getNewProductType());
